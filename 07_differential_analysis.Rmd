...
```{r ancombc_rand_plot_phy_pre_post, comment="", echo=FALSE, message=FALSE, warning=FALSE, fig.height=10, fig.width=8}
ancombc_rand_table_mag %>%
  mutate(genome=factor(genome,levels=ancombc_rand_table_mag$genome)) %>% 
...
```{r ancombc_rand_plot_pre_post, comment="", echo=FALSE, message=FALSE, warning=FALSE, fig.height=10, fig.width=8, fig.fullwidth=TRUE}
ancombc_rand_table_mag%>%
      mutate(genome=factor(genome,levels=ancombc_rand_table_mag$genome)) %>%
