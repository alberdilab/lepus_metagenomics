...
```{r}
lepus_tree <- read_tree("data/DMB0165.tree.gz")
lepus_annotations <- read_tsv("data/genome_annotations.tsv.xz")
lepus_traits <- annot_to_traits(annot=genome_annotations,genome_index=2,kegg_index=9)
lepus_imputed <- completer(traits = lepus_traits, tree = genome_tree)
```
