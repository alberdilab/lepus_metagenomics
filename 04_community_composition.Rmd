...
```{r phyla_nat, comment="",  message=FALSE, warning=FALSE}
...
```{r phyla_cap, comment="",  message=FALSE, warning=FALSE}
...
```{r phyla_pre, comment="",  message=FALSE, warning=FALSE}
...
```{r phyla_post, comment="",  message=FALSE, warning=FALSE}
...
```{r arch_nat, comment="",  message=FALSE, warning=FALSE}
genome_metadata %>% 
  filter(genome %in% wild_genomes) %>% 
  filter(domain == "d__Archaea")%>%
  dplyr::select(phylum) %>%
...
```{r arch_pre, comment="",  message=FALSE, warning=FALSE}
genome_metadata %>% 
  filter(genome %in% captive_pre_genomes) %>% 
  filter(domain == "d__Archaea")%>%
  dplyr::select(phylum) %>%
...
```{r arch_post, comment="",  message=FALSE, warning=FALSE}
genome_metadata %>% 
  filter(genome %in% captive_post_genomes) %>% 
  filter(domain == "d__Archaea")%>%
  dplyr::select(phylum) %>%
